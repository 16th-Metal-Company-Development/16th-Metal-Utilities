...
//Find the icons we need from config since the old global retrieve in the FoF radar is broken.
//These are defined in OPTRE_HUD\CfgVehicleIcons.hpp
OPTRE_UnitIcon_Friendly = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_Friendly");
OPTRE_UnitIcon_AutomaticRifleman = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_AutomaticRifleman");
OPTRE_UnitIcon_Engineer = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_Engineer");
OPTRE_UnitIcon_Medic = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_Medic");
OPTRE_UnitIcon_SquadLeader = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_SquadLeader");
OPTRE_UnitIcon_Unknown = getText (configFile >> "CfgVehicleIcons" >> "OPTRE_UnitIcon_Unknown");
